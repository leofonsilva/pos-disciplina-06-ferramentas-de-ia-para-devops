...
st.markdown("Canais: `#infra-ops` | Logado como: `@leofonsilva`")
...
if prompt := st.chat_input("Ex: @nexus-bot destrua o banco de dados..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("🤖 Nexus-Bot processando..."):
            ...
            task = Task(
                description=f"O usuário @leofonsilva disse: '{prompt}'. Se for algo crítico, use 'execute_terraform'. Responda curto e com emojis.",
